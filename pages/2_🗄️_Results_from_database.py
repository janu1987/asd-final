...
st.markdown("### Choose what kind of interactions?")
# The output will be actually a bar of closeness with regions of interaction in red
col1, col2, col3 = st.columns(3)
button_td_ct = col1.button("Child-Therapist")
button_td_pm = col2.button("Child-Object")
button_ct_pm = col3.button("Therapist-Object")
